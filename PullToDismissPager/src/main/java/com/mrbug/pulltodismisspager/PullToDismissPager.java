...
/**
 * Created by krntija on 9/2/14.
 */

public class PullToDismissPager extends ViewGroup {

    private static final String TAG = PullToDismissPager.class.getSimpleName();
    ...
    public PullToDismissPager(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PullToDismissPager(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            if (ta != null) {
                ...
                mSlideState = SlideState.values()[ta.getInt(R.styleable.PullToDismissPager_initialState, DEFAULT_SLIDE_STATE.ordinal())];
            }
    ...
    private int computePanelTopPosition(float slideOffset) {
        ...
        return mIsSlidingUp
                ...
                : getPaddingTop() - slidingViewHeight + slidePixelOffset;
    }
